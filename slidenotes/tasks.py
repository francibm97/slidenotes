...
def generate_pdf(self, filename, client_filename, original_layout, options, client_ua, client_ip):
    ...
    return {'filename': filename, 'progress': 100, 'client_filename': client_filename}
